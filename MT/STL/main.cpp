...
//использовать set с собственной ф-ией сортировки, которая будет работать по степени
//сегмент выражения - это знак+число+буква+степень -3x^2
//просто число не учитывать
